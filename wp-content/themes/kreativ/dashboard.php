...
array( "name" => "Disable Big Featured section?",
			"desc" => "Tick to disable Featured (lead) section.",
			"id" => $shortname."_disfeatbig",
			"type" => "checkbox",
			"std" => "false"),
...
array( 	"name" => "Big Featured  category",
			"desc" => "Select the category that you would like to have displayed in the Big Featured section on your homepage.",
			"id" => $shortname."_featbig_category",
