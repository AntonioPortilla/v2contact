<?php
/* Template Name: Template Registro Afiliados */
  ...
  <div class="bg-menu">
    <nav class="primary clearfix container" style="padding-top: 40px;">
      <div class="titol"><span class="title_registro">Crea tu Cuenta de Afiliado en <font face="Open Sans extrabold V2C">3 Simples</font> Pasos</span></div>
    </nav> 
  </div>        
  <?php } ?>
...
<?php } ?>
      ...
      <div id="bloque1" class="bg-white">
        <div class="bg-menu" id="bg_registro2"><!--bg_registro-->
                      ...
                      <div class="info" style="margin-top: 12px;">
                        <p class="adress tres">
                          <span style="margin-top: 17px;">
                            FELICIDADES haz activado tu cuenta!<br>
                            Accede a tu cuenta y obtén tu enlace de <br>afiliado
                            Es momento de comenzar a <br>Generar INGRESOS :)
                          </span>
                        </p>
                      </div>
                    </div>
      ...
      <div id="bloque2" class="bg-white" style="display: none;">
        <div class="bg-menu" id="bg_registro2"><!--bg_registro-->
            <div id="content_register" class="primary clearfix container" style="height: auto;">
              ...
              <div class="iconV2C" style="padding-bottom: 240px;">
...
/**/
  var doit = '';
  doit = 'AFILIADOCODECALL';
  var $this = jQuery(this), $input = $this.find(':input');
