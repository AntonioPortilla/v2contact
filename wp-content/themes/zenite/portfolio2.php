...
?> <?php //$terms_as_text = strip_tags( get_the_term_list( $wp_query->post->ID, 'portfolio_category', '', ' ', '' ) );echo $terms_as_text; ?>">
                    ...
                    <div class="imagen"><div class="hover"><a href="<?php the_permalink(); ?>"><div class="link"></div></a></div><?php the_post_thumbnail('portfolio2'); //the_post_thumbnail(436,264); ?></div>
