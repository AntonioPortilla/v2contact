      ...
      <div class="bg-menu" style="background: #FFFFFF;height: auto; padding-top: 25px;">
            <div class="primary clearfix container" style="height: auto;">
				...
				<ul>
					<li class="head">
						<h5>Plan Starter</h5>
						<span class="price" style="display:initial; font-size: 40px;"><font face="Open Sans extrabold V2C">$19</font></span>
					</li>
				<ul>
				...
				<ul>
					<li class="head">
						<h5>Plan Bronce</h5>
						<span class="price" style="display:initial;font-size: 40px;"><font face="Open Sans extrabold V2C">$75</font></span>
					</li>
				<ul>
				...
				<ul>
					<li class="head">
						<h5>Plan Plata</h5>
						<span class="price" style="display:initial;font-size: 40px;"><font face="Open Sans extrabold V2C">$170</font></span>
					</li>
				<ul>
				...
				<ul>
					<li class="head">
						<h5>Plan Oro</h5>
						<span class="price" style="display:initial;font-size: 40px;"><font face="Open Sans extrabold V2C">$320</font></span>
					</li>
				<ul>
