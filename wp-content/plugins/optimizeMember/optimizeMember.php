...
*
* Copyright: © 2009-2011
* {@link http://www.v2contact.com/ v2contact, Inc.}
* ( coded in the USA )
*
...
Copyright: © 2009 v2contact
License: GNU General Public License
Contributors: v2contact

Author: V2Contact
Author URI: http://www.v2contact.com/

Text Domain: s2member
Domain Path: /includes/translations

Plugin Name: V2ContactMember

Description: V2ContactMember, a powerful (free) membership plugin for WordPress. Protect/secure members only content with roles/capabilities.
...
/**
* The installed version of V2ContactMember.
*
* @package optimizeMember
* @since 3.0
*
