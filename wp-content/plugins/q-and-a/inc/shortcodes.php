...
function qa_search() { 
    ...
    $searchform = '<form role="search" method="get" id="qaplus_searchform" action="' . home_url() . '">
		<input type="text" value="" placeholder="' . __('Buscar Preguntas', 'qa-plus') . '" name="s" id="qasearch" class="qaplus_search" />
		<input type="hidden" name="search_link" id="qa_search_link" value="' . home_url() . '/' . $qaplus_options['faq_slug'] . '/search/"/>
		<input type="submit" id="qaplus_searchsubmit" value="Buscar" />
		</form>';
