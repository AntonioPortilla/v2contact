...
class WPCW_CourseProgress extends WP_Widget
{
	...
	function update($new_instance, $old_instance) 
	{
		...
		$instance['option_show_course_title'] 	= $new_instance['option_show_course_title'];
		$instance['option_show_course_desc'] 	= $new_instance['option_show_course_desc'];
		$instance['option_show_module_desc'] 	= $new_instance['option_show_module_desc'];
		$instance['option_course'] 				= strip_tags($new_instance['option_course']);
		$instance['option_module'] 				= strip_tags($new_instance['option_module']);
		
		// Module visibility Toggling
		$instance['option_toggle_modules'] 			= esc_attr($new_instance['option_toggle_modules']);
		$instance['option_show_modules_previous']	= esc_attr($new_instance['option_show_modules_previous']);
		$instance['option_show_modules_next']		= esc_attr($new_instance['option_show_modules_next']);
		$instance['option_show_only_on_units']		= esc_attr($new_instance['option_show_only_on_units']);
